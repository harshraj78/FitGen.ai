...
import { GoalsPage, MemberDashboard, MemberProfilePage, MemberRequestsPage, ProgressPage, WorkoutPage } from "@/features/member/MemberDashboard";
import { BusinessOnboardingPage, TrainerOnboardingPage } from "@/features/onboarding/OnboardingPages";
    ...
    <Routes>
      ...
      <Route element={<RequireAuth redirectTo="/app/login" />}>
        <Route element={<MemberLayout />}>
          ...
          <Route path="/app/onboarding" element={<MemberProfilePage />} />
          <Route path="/app/workout" element={<WorkoutPage />} />
          <Route path="/app/progress" element={<ProgressPage />} />
          <Route path="/app/requests" element={<MemberRequestsPage />} />
